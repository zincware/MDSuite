...
def test_rdf_project(traj_files, true_values, tmp_path):
    ...
    project.run_computation.RadialDistributionFunction(number_of_configurations=-1)
...
def test_rdf_experiment(traj_files, true_values, tmp_path):
    ...
    project.experiments['NaCl'].run_computation.RadialDistributionFunction(number_of_configurations=-1)
